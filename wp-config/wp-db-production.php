...
define('DB_NAME', 'lovellfa_lf_07_20_17');
/** MySQL database username */
define('DB_USER', 'lovellfa_star');
/** MySQL database password */
define('DB_PASSWORD', 'UH4PirJTKryUgQxKXFaKeken');
/** MySQL hostname */
...
define('DB_COLLATE', '');
define('WP_HOME','http://143.95.32.199/~lovellfairchild/');
define('WP_SITEURL','http://143.95.32.199/~lovellfairchild/');
