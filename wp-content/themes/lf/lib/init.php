...
function setup() {
  ...
  // Enable post ordering.
  add_post_type_support( 'clients', 'page-attributes' );
  add_post_type_support( 'client_type', 'page-attributes' );
  ...
  // add_image_size( 'name', width, height, array( 'h', 'v' ) );
