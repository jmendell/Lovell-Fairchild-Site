...
<?php while (have_posts()) : the_post(); ?>
	...
	<div class="overlay"></div>
		<figure class="background background--move100">
			<img src="<?php echo get_template_directory_uri() ?>/dist/images/loader.png" class="responsive" alt="" data-src='{"m":"<?php echo get_field('background_image')[1]['mobile_image']['url']; ?>","d":"<?php echo get_field('background_image')[1]['desktop_image']['url']; ?>"}'/>
			<img src="<?php echo get_template_directory_uri() ?>/dist/images/loader.png" alt="background">
		</figure>
		<div class="content-container">
